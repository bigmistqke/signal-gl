import { createComponent, mergeProps as mergeProps$1, ssrElement } from 'file:///Users/bigmistqke/Documents/GitHub/signal-gl/node_modules/.pnpm/solid-js@1.8.7/node_modules/solid-js/web/dist/server.js';
import { vec3, mat4, quat } from 'file:///Users/bigmistqke/Documents/GitHub/signal-gl/node_modules/.pnpm/gl-matrix@3.4.3/node_modules/gl-matrix/cjs/index.js';
import { createContext, createSignal, untrack, createEffect, mapArray, mergeProps, useContext, onCleanup, createMemo, createResource, Show, splitProps, children, onMount, batch, createRenderEffect } from 'file:///Users/bigmistqke/Documents/GitHub/signal-gl/node_modules/.pnpm/solid-js@1.8.7/node_modules/solid-js/dist/server.js';
...
import { createStore } from 'file:///Users/bigmistqke/Documents/GitHub/signal-gl/node_modules/.pnpm/solid-js@1.8.7/node_modules/solid-js/store/dist/server.js';
  ...
  const cast = (origin, direction) => {
    ...
    for (const collider of colliders) {
      if (collider.intersects(origin, direction)) {
        (_a = collider.onEvent) == null ? void 0 : _a.call(collider, {
          type: "raycast",
          hit: true
        });
      } else {
        (_b = collider.onEvent) == null ? void 0 : _b.call(collider, {
          type: "raycast",
          hit: false
        });
      }
...
export { AxisAlignedBoxCollider as A, Camera as C, Group as G, Scene as S, Cube as a, Shape as b, createRaycaster as c, ColliderProvider as d, fly as f, loadOBJ as l, orbit as o };
//# sourceMappingURL=index-ac642af0.mjs.map
